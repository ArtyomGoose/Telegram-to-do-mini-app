...
# from openai import AsyncOpenAI  # [VOICE] needed for transcription
...
# [VOICE] Voice handler — disabled, pending OPENAI_API_KEY setup
...
def main() -> None:
    ...
    # app.add_handler(MessageHandler(filters.VOICE, handle_voice))  # [VOICE] disabled
